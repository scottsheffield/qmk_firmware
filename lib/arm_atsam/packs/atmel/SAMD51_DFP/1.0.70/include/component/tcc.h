...
typedef union {
  struct {
    ...
    uint32_t MSYNC:1;          /*!< bit:     15  Leader Synchronization (only for TCC Follower Instance) */
...
#define TCC_CTRLA_MSYNC_Pos         15           /**< \brief (TCC_CTRLA) Leader Synchronization (only for TCC Follower Instance) */
